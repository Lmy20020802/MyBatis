...
public class DynamicSQLMapperTest {
    ...
    @Test
    public void test01(){
        SqlSession sqlSessionq= SqlSeesionUtils.getSqlSession();
        DynamicSQLMapper mapper = sqlSessionq.getMapper(DynamicSQLMapper.class);
